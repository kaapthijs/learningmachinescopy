...
if __name__ == "__main__":
    ...
    train_q_table(rob,'red', RUN_NAME, q_table, q_table_path, result_path, num_episodes=5, max_steps=40, epsilon=0.30)

    # Train the Q-table for GREEN
    #train_q_table(rob,'green', RUN_NAME, q_table, q_table_path, result_path, num_episodes=15, max_steps=20, epsilon=0.30)
